<?php
require_once "../modules/protectedpage/Authentication.php";
new Module_ProtectedPage_Authentication(array (
  'realm' => 'lavasecototal.co',
  'username' => 'LTotal',
  'password' => 'poligrangerencia',
  'labels' => 
  array (
    'title' => 'Acceso protegido a páginas del sitio web',
  ...
  array (
    ...
    'previewDetected' => 'El acceso protegido a las páginas del sitio web no funciona en el modo de vista previa de sitio web Parallels Panel.',
  ),
));
?>
...
<head>
	...
	<title>Gestion Financiera - lavasecototal.co</title>
...
#widget-6f25298a-b984-4ca2-a76f-3163dc316e86 {
	margin: 0px 0px 0px 0px;
	padding: 0px 10px 0px 10px;
	border-radius: 0 0 0 0;
}
#widget-6f25298a-b984-4ca2-a76f-3163dc316e86 {box-shadow: none}
...
#widget-e2b08066-ab6c-4213-9fb1-e8bc4dbb80a2 {
	margin: 0px 0px 0px 0px;
	padding: 0px 10px 0px 10px;
	border-radius: 0 0 0 0;
}
#widget-e2b08066-ab6c-4213-9fb1-e8bc4dbb80a2 {box-shadow: none}
...
#widget-421c4684-78fa-4d23-bbb0-ceab7e0e060a {
	margin: 0px 0px 0px 0px;
	padding: 0px 10px 0px 10px;
	border-radius: 0 0 0 0;
}
#widget-421c4684-78fa-4d23-bbb0-ceab7e0e060a {box-shadow: none}
...
<link type="text/css" href="../css/text-6f25298a-b984-4ca2-a76f-3163dc316e86.css?template=generic" rel="stylesheet" />
...
<link type="text/css" href="../css/text-e2b08066-ab6c-4213-9fb1-e8bc4dbb80a2.css?template=generic" rel="stylesheet" />
...
<link type="text/css" href="../css/text-421c4684-78fa-4d23-bbb0-ceab7e0e060a.css?template=generic" rel="stylesheet" />
...
<body id="template" class="">
	...
	<div class="widget-content"><a id="navigation-toggle-dfb94903-3b09-4b86-a160-c99e20984326"></a><ul class="navigation" id="navigation-dfb94903-3b09-4b86-a160-c99e20984326">
			...
			<a href="../gestion-financiera/">
				<span class="navigation-item-bullet">></span>
				<span class="navigation-item-text">Gestion Financiera</span>
			</a>
			
		</li><li class="normal">
			<a href="../app/">
				<span class="navigation-item-bullet">></span>
				<span class="navigation-item-text">app</span>
			</a>
			...
			<a href="../gestion-de-inventario/">
				<span class="navigation-item-bullet">></span>
				<span class="navigation-item-text">Gestión de Inventario</span>
			</a>
...
<h2><span style="color: #091118;"><span style="font-weight: bold; font-size: 16px;">lista de bandejas&nbsp;</span></span></h2></div>
</div>

	<div class="widget widget-text " id="widget-73a7080e-3cb5-406d-95b8-4fafa659d336">
	<div class="widget-content"><p>Con la appLavaSeco puedes programar tus lavados, apartar tu sesion de lavados, ver el estado de tus prendas, y mas..</p>
<p><span><a class=" link" href="../">Mas_info &gt;&gt;</a></span></p></div>
</div>

	<div class="widget widget-pagecontent " id="widget-5a18d78e-26e5-4d61-8a84-c47eeafd4450">
	<div class="widget-content"><div class="widget widget-text " id="widget-e2b08066-ab6c-4213-9fb1-e8bc4dbb80a2">
	<div class="widget-content"></div>
</div></div>
</div>

	<div class="widget widget-text " id="widget-8a1b327e-c2bc-4178-818e-cfbdae48d896">
	<div class="widget-content"><h2 style="text-align: center;"><span style="font-size: 22px; color: #000000;">Nuestra infraestructura</span></h2></div>
</div>
	...
	<div class="widget-content"><div class="widget widget-text " id="widget-6f25298a-b984-4ca2-a76f-3163dc316e86">
	<div class="widget-content"><p>&nbsp;</p>
<p><a class=" link" href="../contabilidad-tesoreria/">Contabilidad / Tesoreria</a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</p></div>
</div></div>
</div>
...
siteBuilderJs(document).ready(function ($) {
		$.addImagesAnimation('#widget-6f25298a-b984-4ca2-a76f-3163dc316e86');$("#navigation-toggle-dfb94903-3b09-4b86-a160-c99e20984326").click(function(e) {
				e.preventDefault();
				$("#navigation-dfb94903-3b09-4b86-a160-c99e20984326").slideToggle();
			});
	$.addImagesAnimation('#widget-aee91b9d-faf4-45f8-9928-6795afccd196');	$.addImagesAnimation('#widget-73a7080e-3cb5-406d-95b8-4fafa659d336');	$.addImagesAnimation('#widget-e2b08066-ab6c-4213-9fb1-e8bc4dbb80a2');	$.addImagesAnimation('#widget-8a1b327e-c2bc-4178-818e-cfbdae48d896');	$.addImagesAnimation('#widget-f98d32ea-ae3d-4a16-84c8-b3aff49b9600');	$.addImagesAnimation('#widget-421c4684-78fa-4d23-bbb0-ceab7e0e060a');	$.addImagesAnimation('#widget-db472928-43e5-49c6-8018-030e8a5b5901');	$.addImagesAnimation('#widget-ef822add-3a77-4295-9170-434b9f03d8cb');
});
</script>
</body>
</html>